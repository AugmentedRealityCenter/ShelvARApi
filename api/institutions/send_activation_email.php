<?php
	...
	if(isset($editAdmin)) 
	{
		...
		$message = "<img src='".$api."ShelvARLogo_Big.png' /><br/><br/>Dear " . $admin_contact . ",<br/><br/>This email is to confirm that you are no longer the administrator of the the ShelvAR account for ".$result[0]['name'].".<br/><br/>If you did not intend to change the admin of this institution, please contact support@shelvar.com.";
