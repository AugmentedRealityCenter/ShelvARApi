<?php
	...
	$message = "<img src='".$api."ShelvARLogo_Big.png' /><br/>Welcome to ShelvAR!<br/><br/>You, or someone using your email address, has completed registration at ShelvAR.com. You can complete registration by clicking the following link:<br/>".$api."activate_email.php?$activation_key";
