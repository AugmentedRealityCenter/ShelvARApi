...
`consumer_create_date` date() NOT NULL,
...
`request_token_date` date() NOT NULL,
`request_token_consumer_key` varchar(40) NOT NULL,
`request_token_callback` varchar(50) NOT NULL,
`request_token_scope` varchar(50) NOT NULL,
...
`access_token_date` date() NOT NULL,
`access_token_consumer_key` varchar(40) NOT NULL,
`access_token_scope` varchar(50) NOT NULL,
