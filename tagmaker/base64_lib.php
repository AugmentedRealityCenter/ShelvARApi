 ...
 * base64_lib.php
 *
 * A function library used to convert a binary string to a base64-encoded 
 * string, as well as the reverse.
 * 
 ...
 * -'_' is 63
 * 
 * WARNING: Any call to these MUST have a legal input. I.e., any binary call
 * must be a legal binary call, and any base64 call must be a legal base64
 * call.
 * 
 */
